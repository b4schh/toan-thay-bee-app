    ...
    <View style={{ flex: 1 }}>
      {!isStarted ? (
        <>
          ...
          <Button title="🎬 Bắt đầu làm bài" onPress={handleStartExam} />
        </>
      ) : (
        <ScrollView
        ...
        >
            ...
            <View>
              {currentQuestion?.statements?.map((statement) => (
                <TouchableOpacity
                  ...
                  onPress={() => handleSelectAnswerTN(currentQuestion.id, statement.id, currentSection.type)}
                >
                  <View style={styles.radioCircle}>
                    {(answerTN?.find((answer) => answer.questionId === currentQuestion.id)?.answerContent == statement.id) && (
                  ...
                  <View key={statement.id} style={styles.trueFalseContainer}>
                    ...
                    <View style={styles.trueFalseButtons}>
                      <Button
                        ...
                        onPress={() =>
                          handleSelectAnswerDS(currentQuestion.id, statement.id, true)
                        }
                      />
                      <Button
                        text="Sai"
                        ...
                        onPress={() =>
                          handleSelectAnswerDS(currentQuestion.id, statement.id, false)
                        }
                      />
                    </View>
                  </View>
          ...
          {currentSection.type === 'TLN' && (
            <TextInput
              ...
              onBlur={() => {
                handleSelectAnswerTLN(currentQuestion.id, tlnInput, currentSection.type);
              }}
            />
          )}
